								...
								<a name='8261437882122457741'></a>
									...
									<header class='entry-header'>
										<h1 class='post-title entry-title' itemprop='name'>
											<a  id="header_text2" href='/post/{{$postdata->cat}}/{{$postdata->id}}'>
											{{$postdata->title}}
											</a>
										</h1>
									...
									<a href='#' onclick=''>{{$postdata->comment_count}}  comment</a>
...
<footer class='entry-footerpbt'>
	<div class='readMoreLinkpbt'>
		<a href='/post/{{$postdata->cat}}/{{$postdata->id}}'>Read More<i class='fa spaceLeft fa-angle-double-right'></i></a>
	</div>
</footer>
