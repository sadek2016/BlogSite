								...
								<a name='8261437882122457741'></a>
									...
									<header class='entry-header'>
										<h1 class='post-title entry-title' itemprop='name'>
											<a  id="header_text2" href='#'>{{$postdata->title}}</a>
										</h1>
									...
									<meta content='#' itemprop='url'/>
										<a class='timestamp-link' href='#' rel='bookmark' title='permanent link'>
											<span class='published updated' itemprop='datePublished' title=''>{{$postdata->updated_at}}</span>
										</a>
	...
	<div id='summary8261437882122457741'>
		<div class="" style="clear: both; text-align: center;">
			<a href="#" imageanchor="1" style="clear: left; float: left; margin-bottom: 1em; margin-right: 1em;">
				<img src='{{asset("$postdata->image")}}' width="250px" height="100px">
			</a>
		</div>
		<?php  echo substr($postdata->body,0,900); ?>
...
<div class='pbtsharethisbutt'>
	<ul class='pbt-social-icons'>
		...
		<li class='pbtstumbleupon'>
			<a href='http://{{$sociallink->linkedin}}' rel='nofollow' target='_blank' title='Stumble upon something good? Share it on StumbleUpon'>
...
<footer class='entry-footerpbt'>
	<div class='readMoreLinkpbt'>
		<a href='/post/{{$postdata->id}}'>Read More<i class='fa spaceLeft fa-angle-double-right'></i></a>
	</div>
</footer>
